...
import OldCode.Main.Components.MouseMove;
...
import OldCode.Main.View.Camera;
...
public class Main {
    ...
    public void logic() {
        for (GameObject g : gameObjects) {
            ...
            g.sendMessage("update", args, false);
        }
    }
    ...
    private void load() {
        ...
        Transform transform = new Transform(new Vector3f(0, 0, 0), new Vector2f(10, 10));
        Renderer renderer = new Renderer(transform, animator);

        o.addComponent(renderer);
        o.addComponent(transform);
        o.addComponent(new MouseMove());
        gameObjects.add(o);
        // vv shouldn't be here, move later
